...
namespace Combat
{
    public class SyncParam
    {
         ...
         */
        public const int FRAME_TIME = 25;                                        //逻辑的更新间隔
        public const int FRAME_COUNT_PER_SYNCTURN = 4;                           //一个syncturn含几个frame
        ...
        public const int MAX_LATENCY = 100;                                      //ZZWTODO，多玩家时，提供一个经测试的能容忍的最大延迟
