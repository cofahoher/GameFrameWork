...
namespace Combat
{
    public class ExpressionVariable : IRecyclable
    {
        ...
        public static readonly int VID_Value = (int)CRC.Calculate("Value");                     //属性的当前最终值
        public static readonly int VID_BaseValue = (int)CRC.Calculate("BaseValue");             //属性的基础值
        public static readonly int VID_ModifierList = (int)CRC.Calculate("ModifierList");       //属性修改器
