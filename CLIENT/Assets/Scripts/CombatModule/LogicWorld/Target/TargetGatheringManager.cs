...
namespace Combat
{
    ...
    public class TargetGatheringManager : IDestruct
    {
        ...
        //public void OLD_BuildTargetList(Entity source_entity, TargetGatheringParam param, List<Target> targets)
        //{
        ...
        //    ISpacePartition space_manager = m_logic_world.GetSpacePartition();
        ...
        //    {
        //        ids = space_manager.CollectEntity_ForwardRectangle(position_cmp.CurrentPosition, position_cmp.Facing2D, param.m_param1, param.m_param2, source_entity.ID);
        //    }
        //    else if (gathering_type == TargetGatheringType.SurroundingRing)
        //    {
        //        ids = space_manager.CollectEntity_SurroundingRing(position_cmp.CurrentPosition, param.m_param1, param.m_param2, source_entity.ID);
        //    }
        //    else if (gathering_type == TargetGatheringType.ForwardSector)
        //    {
        //        ids = space_manager.CollectEntity_ForwardSector(position_cmp.CurrentPosition, position_cmp.Facing2D, param.m_param1, param.m_param2, source_entity.ID);
        //    }
        ...
        //        //    continue;
        //        if (!FactionRelation.IsFactionSatisfied(source_player.GetFaction(entity.GetOwnerPlayerID()), param.m_faction))
        //            continue;
        //        Target target = RecyclableObject.Create<Target>();
        //        target.Construct();
        //        target.SetEntityTarget(entity);
